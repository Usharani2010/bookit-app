...
const Header: React.FC<HeaderProps> = ({ searchTerm = '', onSearchChange }) => {
  ...
  return (
    <header className="sticky top-0 z-20 bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
      <div className="gap-2 max-w-[1400px] mx-auto px-16 py-4 flex items-center justify-between">
        {/* Logo - Left side */}
...
<form onSubmit={handleSearch} className="flex gap-3 w-full max-w-2xl">               <input
                type="text"
              ...
              <button 
                type="submit"
                className="rounded-lg px-6 py-3 bg-[#FFD247] font-semibold text-gray-900 hover:brightness-95"
              >
                Search
              </button>
            </form>
